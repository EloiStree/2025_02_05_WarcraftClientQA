...
public class Program {
    ...
    public static void Main(string[] args) {
        PushIntegerToGameUDP allUdp = new PushIntegerToGameUDP(
            "127.0.0.1", 7073, 0);
        PushIntegerToGameUDP healerUdp = new PushIntegerToGameUDP(
            "127.0.0.1", 7073, 1);
        PushIntegerToGameUDP playerUdp = new PushIntegerToGameUDP(
            "127.0.0.1", 7073, 2);

        Champion champion = new Champion(playerUdp);
        Champion champions = new Champion(allUdp);
        Champion healer= new Champion(healerUdp);
        ...
        while (true) {
            ...
            //champions.WriteAlpahNumericalCommand("dance");

            TestAllCommands(champions);
...
public class Champion {
    ...
    public void WaitSomeSeconds(int seconds) => Thread.Sleep((int)(seconds*1000f));
    ...
    public void StopForward() => ReleaseKey(WowIntegerKeyboard.ArrowUp);
    ...
    public void StartRight() => PressKey(WowIntegerKeyboard.ArrowRight);
    public void StopRight() => ReleaseKey(WowIntegerKeyboard.ArrowRight);
...
public class WowCommandList {
    //https://wowwiki-archive.fandom.com/wiki/Slash_commands
    public const string TeamInvite = "tinvite";
    public const string TeamQuit = "tquit";
    public const string TeamRemove = "tremove";
    public const string OpenCalendar = "opencalendar";
    public const string TimeWatch = "stopwatch";
    public const string InstanceChat = "instance";
    ...
    public const string PlayedTime = "played";
    public const string ReloadUI = "reload";
    public const string Time = "time";
    public const string Who = "who";
    public const string RandomDice = "random";
